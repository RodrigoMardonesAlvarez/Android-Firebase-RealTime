package com.example.realtimefirebasecrud;
...
public class UsersRecyclerAdapter extends RecyclerView.Adapter<UsersRecyclerAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.user_item, parent, true);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String currentName = "Name :" + users.getUserName();
        String currentEmail = "Email : " + users.getUserEmail();
        String currentCountry = "Country : " + users.getUserCountry();

        holder.textName.setText(currentName);
        holder.textEmail.setText(currentEmail);
        holder.textCountry.setText(currentCountry);
